...
The dispatch component is written using GO lang, it implements the dispatch section of website.
...
The following steps are to be performed to build the dispatch component
